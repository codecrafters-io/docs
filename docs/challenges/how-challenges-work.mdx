...
<Tip> 
  ...
  <Steps>
    <Step title="Open Terminal on your system">
      On Windows, you can use [Command Prompt `(cmd)`](https://www.youtube.com/results?search_query=how+to+open+cmd) or [PowerShell](https://www.youtube.com/results?search_query=how+to+open+powershell), but we recommend using [WSL](https://learn.microsoft.com/en-us/windows/wsl/install).
    </Step>
    <Step title="Set up Git">
      Make sure Git is [installed](https://git-scm.com/download/win) and [set up properly](https://git-scm.com/book/en/v2/Getting-Started-First-Time-Git-Setup).
    </Step>
