...
<Tip> 
  ...
  <Steps>
    <Step title="Open Terminal on your system">
      If you're using Windows, make sure to [install WSL](https://learn.microsoft.com/en-us/windows/wsl/install).
    </Step>
    <Step title="Set up Git">
      Make sure Git is [set up properly](https://git-scm.com/book/en/v2/Getting-Started-First-Time-Git-Setup).
    </Step>
