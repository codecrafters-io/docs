...
To run the code for your challenge locally, you'll need `Rust` installed. Our test runners use version `1.76` (as of April 2024).
...
For example, if you added a file at `src/foo.rs`, you could use it like so:
...
Since version 1.62, Rust allows adding dependencies using `cargo add`.
