...
The script for your challenge (like `./spawn_redis_server.sh`) will run the code using [Bundler](https://bundler.io/), a dependency manager which comes preinstalled with Ruby. It looks something like this:
...
`Gemfile` lists your project's dependencies. You can add depdendencies by specifying the name of the gem and optionally the version.
...
It will also update your `Gemfile.lock` file.
