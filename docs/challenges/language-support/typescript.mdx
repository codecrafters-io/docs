...
The script for your challenge (like `./your_grep.sh`) will automatically compile your code using `bun` before executing it. It'll
...
Refer to the Bun [documentation](https://bun.sh/docs/runtime/modules) for resolving modules in special cases.
