...
This integration allows users to publish their projects from the CodeCrafters platform to GitHub with just a couple of clicks.

Each course available on CodeCrafters includes an option in the language dropdown menu to **"Publish to GitHub"**:
