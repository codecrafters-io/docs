...
View [Course Definition Reference](https://docs.codecrafters.io/authoring-challenges/course-definition-reference) for a description of all the fields in `course-definition.yml`.
