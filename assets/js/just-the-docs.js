(function (jtd, undefined) {
    ...
    function initNavBar() {
      return fetch("https://docs.codecrafters.io/nav.html").then(function (response) {
    ...
    function initSearch() {
      ...
      request.open("GET", "https://docs.codecrafters.io/assets/js/search-data.json", true);
    ...
    jtd.setTheme = function (theme) {
      ...
      cssFile.setAttribute(
        "href",
        'https://docs.codecrafters.io/assets/css/just-the-docs-' + theme + ".css"
      );
    };
